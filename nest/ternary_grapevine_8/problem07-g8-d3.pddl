...
(define (problem testing)
    ...
    (:goal
      (and
        ...
        ; {"query_info":{"id":"p1","query":"dk 1 dk 1 dk 1 obj_1:value:2"}}
        ; {"query_info":{"id":"p2","query":"dk 2 dk 2 dk 2 obj_1:value:3"}}
        ; {"query_info":{"id":"p3","query":"dk 3 dk 3 dk 3 obj_1:value:4"}}
        ; {"query_info":{"id":"p4","query":"dk 4 dk 4 dk 4 obj_1:value:1"}}
        ; {"query_info":{"id":"n1","query":"dk 1 dk 1 dk 1 obj_1:value:4"}}
        ; {"query_info":{"id":"n2","query":"dk 2 dk 2 dk 2 obj_1:value:1"}}
        ; {"query_info":{"id":"n3","query":"dk 3 dk 3 dk 3 obj_1:value:2"}}
        ; {"query_info":{"id":"n4","query":"dk 4 dk 4 dk 4 obj_1:value:3"}}
