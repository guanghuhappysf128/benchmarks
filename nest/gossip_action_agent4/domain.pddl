(define (domain s_media)
	...
	(:types 
		agent boolean action_sequence encoding - int
		query
	...
	(:functions
		...
		(@translate ?as1 - action_sequence ?as2 - action_sequence) - encoding
		(@check ?ab - encoding ?ac - encoding ?bc - encoding ?q - query) - boolean
	)
	...
	(:action calls_a_b
		...
		(and
			...
			(assign (calling_b_d) (@update 0 (calling_b_c)))
			(assign (calling_c_d) (@update 0 (calling_b_c)))
	...
	(:action calls_b_d
		...
		(and
			...
			(assign (calling_a_d) (@update 0 (calling_a_d)))
			(assign (calling_b_c) (@update 0 (calling_b_c)))
			(assign (calling_b_d) (@update 1 (calling_b_c)))
			(assign (calling_c_d) (@update 0 (calling_b_c)))
	...
	(:action calls_c_d
		...
		(and
			...
			(assign (calling_b_c) (@update 0 (calling_b_c)))
			(assign (calling_b_d) (@update 0 (calling_b_c)))
			(assign (calling_c_d) (@update 1 (calling_b_c)))
