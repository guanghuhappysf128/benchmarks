...
(define (problem testing001)
    ...
    (:init
      ...
      ; {"agent_info":{"id":"agt_a","location":"0,0","direction":"45","range":"90","name":"alice"}}
    ...
    (:goal
      ...
      (and
        ...
        ;(= (fact p1) 1)
        ;(= (fact n1) 0)
        ; {"query_info":{"id":"p1","query":"dk agt_a dk atg_a,agt_b obj_1:name:box1|dk agt_a dk atg_a,agt_b obj_2:name:box2|dk agt_a dk atg_a,agt_b obj_3:name:box3"}}
