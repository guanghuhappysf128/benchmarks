(define (domain grapevine)
	...
	(:functions
		...
		(loc_encode ?a1 - agent ?a2 - agent ?a3 - agent) - encode
 	...
 	(:action a_share
 		...
 		(and
 			...
 			(forall (?q - query) (when (= (@check (loc_encode (location 1) (location 2) (location 3)) (location 1) ?s ?q) 1) (assign (fact ?q) 1)))
 	 ...
 	 (:action b_share
 		...
 		(and
 			...
 			(forall (?q - query) (when (= (@check (loc_encode (location 1) (location 2) (location 3)) (location 2) ?s ?q) 1) (assign (fact ?q) 1)))
 		)
 	)
 	...
 	(:action c_share
 		...
 		(and
 			...
 			(forall (?q - query) (when (= (@check (loc_encode (location 1) (location 2) (location 3)) (location 3) ?s ?q) 1) (assign (fact ?q) 1)))
 		)
 	)
