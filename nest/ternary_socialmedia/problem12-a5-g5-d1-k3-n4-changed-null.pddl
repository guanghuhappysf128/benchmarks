...
(define (problem testing)
    ...
    (:init
        ...
        ; {"agent_info":{"id":"1","visible":"yes","friendwith1":"1","friendwith2":"1","friendwith3":"1","friendwith4":"1"}}
        ; {"agent_info":{"id":"2","visible":"yes","friendwith2":"1","friendwith1":"1","friendwith5":"1","friendwith4":"1"}}
        ; {"agent_info":{"id":"3","visible":"yes","friendwith3":"1","friendwith1":"1","friendwith4":"1"}}
        ; {"agent_info":{"id":"4","visible":"yes","friendwith4":"1","friendwith1":"1","friendwith3":"1","friendwith5":"1","friendwith2":"1"}}
        ; {"agent_info":{"id":"5","visible":"yes","friendwith5":"1","friendwith2":"1","friendwith4":"1"}}
        ; {"object_info":{"id":"obj_1","belongsto":"0","value":"1","visible":"yes"}}
        ; {"object_info":{"id":"obj_2","belongsto":"0","value":"2","visible":"yes"}}
        ; {"object_info":{"id":"obj_3","belongsto":"0","value":"3","visible":"yes"}}
    ...
    (:goal
      (and
        ...
        (= (fact n3) 1)
        (= (fact n4) 1)
        ; {"query_info":{"id":"p1","query":"dk 1 obj_1:value:1|dk 1 obj_2:value:2|dk 1 obj_3:value:3"}}
        ; {"query_info":{"id":"n1","query":"dk 3 obj_1:value:1|dk 3 obj_2:value:2|dk 3 obj_3:value:3"}}
        ; {"query_info":{"id":"n2","query":"dk 2 obj_1:value:1|dk 2 obj_2:value:2|dk 2 obj_3:value:3"}}
        ; {"query_info":{"id":"n3","query":"dk 4 obj_1:value:1|dk 4 obj_2:value:2|dk 4 obj_3:value:3"}}
        ; {"query_info":{"id":"n4","query":"dk 5 obj_1:value:1|dk 5 obj_2:value:2|dk 5 obj_3:value:3"}}
      )
    )
