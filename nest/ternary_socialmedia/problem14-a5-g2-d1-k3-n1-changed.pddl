...
(define (problem testing)
    ...
    (:init
        ...
        ; {"agent_info":{"id":"3","visible":"yes","friendwith3":"1","friendwith1":"1","friendwith4":"1","friendwith5":"1"}}
        ; {"agent_info":{"id":"4","visible":"yes","friendwith4":"1","friendwith1":"1","friendwith3":"1","friendwith5":"1"}}
        ; {"agent_info":{"id":"5","visible":"yes","friendwith5":"1","friendwith2":"1","friendwith4":"1","friendwith3":"1"}}
    ...
    (:goal
      (and
        ...
        (= (fact p1) 1)
        (= (fact n1) 0)
        ; {"query_info":{"id":"p1","query":"ek 2,3,4,5 obj_1:value:1|ek 2,3,4,5 obj_2:value:2|ek 2,3,4,5 obj_3:value:3"}}
        ; {"query_info":{"id":"n1","query":"dk 1 obj_1:value:1|dk 1 obj_2:value:2|dk 1 obj_3:value:3"}}
      )
    )
