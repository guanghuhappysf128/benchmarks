...
(define (problem testing001)
    ...
    (:init
      ...
      ; {"agent_info":{"id":"agt_d","location":"2","secret":"yes"}}
      ; {"agent_info":{"id":"agt_e","location":"3","secret":"yes"}}
      ; {"agent_info":{"id":"agt_f","location":"2","secret":"yes"}}
      ; {"agent_info":{"id":"agt_g","location":"3","secret":"yes"}}
