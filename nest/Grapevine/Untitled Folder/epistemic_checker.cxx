...
bool check(string str)
{
    ...
    cout << "Step 4:\n";
    cout << "Generate State: \n";
    state_ptr = new State(agents,objects);
...
//    cout << "show knowledge:" << k1.show()<<endl;
    ...
    for (auto i : s_ptr_list)
    {
        ...
        {
            State temp_s=i->getState(*state_ptr);
...
State mergingState(bool uni,State s1,State s2)
{
...
State Seeing::getState(State s)
{
    ...
    {
        State result_state = s.getAgentState(s.getAgent(agent_ids.front()));
